...
jQuery(document).ready(function($){
  ...
  var latitude = 35.8203943,
      longitude = 10.5909016,
      map_zoom = 14;
  ...
  var contentString = '<div id="content">'+
    '<div id="siteNotice">'+
    '</div>'+
    '<h2 id="firstHeading" class="firstHeading">ENISo</h2>'+
    '<div id="bodyContent">'+
    '<p>Pôle technologique de Sousse, <br> Route de Ceinture Sahloul, <br> 4054, Tunisie</p>'+
    '</div>'+
    '</div>';
